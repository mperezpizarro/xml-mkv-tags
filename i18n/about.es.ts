export default {
    ...
    "aboutP5": 'Una vez tengas preparado tu archivo, ve a la pestaña "Salida" haz clic en el botón de la opción "Etiquetas globales" para agregar tu archivo XML previamente generado.',
    "aboutP6": 'Finalmente, haz click en "Iniciar multiplexado" y ya tendrías tu archivo MKV con los metadatos generados.'
}