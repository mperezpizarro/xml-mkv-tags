export default {
    ...
    "aboutP4": 'With the program opened, click into the "Add source files" button and select your desired files. You can also drag and drop the files you want into the program.',
    "aboutP5": 'Once you have finished your Matroska file, go to the "Output" tab and click the button in the "Global tags" option to add your previously generated XML file.',
    "aboutP6": 'At last, click in "Start multiplexing" and you will have your MKV file with the generated metadata.'
}