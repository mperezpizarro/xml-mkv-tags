<template>
    ...
    <article class="w-full mx-auto">
        ...
        <p class="text-lg mb-6">
            Once you have filled all the required fields and the optional ones you want, you will be able to download an XML file to add to your .mkv video.
        </p>
        <p class="text-lg mb-6">
    ...
    <article class="w-full mx-auto">
        ...
        <p class="text-lg mb-6">
            Once you have finished your Matroska file, go to the "Output" tab and click the button in the "Add metatags" option to add your previously generated XML file.
        </p>
        <p class="text-lg mb-6">
            Now you have and MKV file with your desired metadata.
        </p>
    </article>
</template>